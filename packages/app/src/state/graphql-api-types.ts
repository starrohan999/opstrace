...
export type CreateCredentialsMutation = { insert_credential?: Maybe<{ returning: Array<Pick<Credential, 'id'>> }> };
...
export type DeleteCredentialMutation = { delete_credential?: Maybe<{ returning: Array<Pick<Credential, 'id'>> }> };
...
export type GetCredentialQuery = { credential: Array<Pick<Credential, 'id' | 'tenant_id' | 'name' | 'key' | 'type' | 'created_at' | 'updated_at'>> };

export type GetCredentialIdByNameQueryVariables = Exact<{
  tenant_id: Scalars['uuid'];
  name: Scalars['String'];
}>;


export type GetCredentialIdByNameQuery = { credential: Array<Pick<Credential, 'id'>> };
...
export type GetCredentialsQuery = { credential: Array<Pick<Credential, 'id' | 'tenant_id' | 'name' | 'key' | 'type' | 'created_at' | 'updated_at'>> };

export type GetCredentialsDumpQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCredentialsDumpQuery = { credential: Array<Pick<Credential, 'id' | 'tenant_id' | 'name' | 'type' | 'value' | 'created_at' | 'updated_at'>> };

export type SubscribeToCredentialListSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SubscribeToCredentialListSubscription = { credential: Array<Pick<Credential, 'id' | 'tenant_id' | 'name' | 'type' | 'value' | 'created_at' | 'updated_at'>> };
...
export type UpdateCredentialMutation = { update_credential?: Maybe<{ returning: Array<Pick<Credential, 'id'>> }> };

export type CreateExportersMutationVariables = Exact<{
  exporters: Array<Exporter_Insert_Input> | Exporter_Insert_Input;
}>;


export type CreateExportersMutation = { insert_exporter?: Maybe<{ returning: Array<Pick<Exporter, 'id'>> }> };
...
export type DeleteExporterMutation = { delete_exporter?: Maybe<{ returning: Array<Pick<Exporter, 'id'>> }> };
...
export type GetExporterQuery = { exporter: Array<(
    Pick<Exporter, 'id' | 'tenant_id' | 'name' | 'key' | 'type' | 'config' | 'created_at' | 'updated_at'>
    & { credential?: Maybe<Pick<Credential, 'id' | 'name'>> }
  )> };

export type GetExporterIdByNameQueryVariables = Exact<{
  tenant_id: Scalars['uuid'];
  name: Scalars['String'];
}>;


export type GetExporterIdByNameQuery = { exporter: Array<Pick<Exporter, 'id'>> };
...
export type GetExportersQuery = { exporter: Array<(
    Pick<Exporter, 'id' | 'tenant_id' | 'name' | 'key' | 'type' | 'config' | 'created_at' | 'updated_at'>
    & { credential?: Maybe<Pick<Credential, 'id' | 'name'>> }
  )> };
...
export type GetExportersDumpQuery = { exporter: Array<(
    Pick<Exporter, 'id' | 'tenant_id' | 'name' | 'type' | 'config' | 'created_at' | 'updated_at'>
    & { credential?: Maybe<Pick<Credential, 'id' | 'name'>> }
  )> };

export type SubscribeToExporterListSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SubscribeToExporterListSubscription = { exporter: Array<(
...
export type UpdateExporterMutation = { update_exporter?: Maybe<{ returning: Array<Pick<Exporter, 'id'>> }> };
...
export type CreateTenantsMutation = { insert_tenant?: Maybe<{ returning: Array<Pick<Tenant, 'id' | 'name' | 'key'>> }> };
...
export type DeleteTenantMutation = { delete_tenant_by_pk?: Maybe<Pick<Tenant, 'id'>> };
...
export type GetAlertmanagerQuery = { getAlertmanager?: Maybe<Pick<Alertmanager, 'config' | 'online'>> };
...
export type GetTenantByIdQuery = { tenant_by_pk?: Maybe<Pick<Tenant, 'id' | 'key' | 'name' | 'type' | 'created_at'>> };
...
export type GetTenantByNameQuery = { tenant: Array<Pick<Tenant, 'id' | 'key' | 'name' | 'type' | 'created_at'>> };

export type GetTenantsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTenantsQuery = { tenant: Array<Pick<Tenant, 'id' | 'name' | 'key' | 'created_at' | 'type'>> };

export type SubscribeToTenantListSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SubscribeToTenantListSubscription = { tenant: Array<Pick<Tenant, 'id' | 'name' | 'key' | 'created_at' | 'type'>> };
...
export type UpdateAlertmanagerMutation = { updateAlertmanager?: Maybe<Pick<StatusResponse, 'success' | 'error_type' | 'error_message' | 'error_raw_response'>> };
...
export type CreateUserMutation = { insert_user_preference_one?: Maybe<{ user?: Maybe<Pick<User, 'id' | 'email' | 'username' | 'role' | 'active' | 'avatar' | 'created_at' | 'session_last_updated'>> }> };
...
export type DeactivateUserMutation = { update_user_by_pk?: Maybe<Pick<User, 'id' | 'active'>> };
...
export type GetActiveUserForAuthQuery = { user: Array<Pick<User, 'id' | 'email' | 'avatar' | 'username' | 'active'>>, active_user_count: { aggregate?: Maybe<Pick<User_Aggregate_Fields, 'count'>> } };
...
export type GetUserQuery = { user_by_pk?: Maybe<(
    Pick<User, 'id' | 'email' | 'avatar' | 'username' | 'active'>
    & { preference?: Maybe<Pick<User_Preference, 'dark_mode'>> }
  )> };
...
export type ReactivateUserMutation = { update_user_by_pk?: Maybe<Pick<User, 'id' | 'active'>> };
...
export type SetDarkModeMutation = { update_user_preference?: Maybe<{ returning: Array<Pick<User_Preference, 'dark_mode'>> }> };
...
export type SubscribeToUserListSubscription = { user: Array<(
    Pick<User, 'id' | 'email' | 'username' | 'session_last_updated' | 'role' | 'active' | 'avatar' | 'created_at'>
    & { preference?: Maybe<Pick<User_Preference, 'dark_mode'>> }
  )> };
...
export type UpdateUserMutation = { update_user_by_pk?: Maybe<Pick<User, 'id' | 'email' | 'username' | 'avatar' | 'session_last_updated'>> };
...
export type UpdateUserSessionMutation = { update_user_by_pk?: Maybe<Pick<User, 'id' | 'session_last_updated'>> };
...
export const DeleteCredentialDocument = gql`
    mutation DeleteCredential($tenant_id: uuid!, $id: uuid!) {
  delete_credential(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}) {
    returning {
      id
    }
  }
...
export const GetCredentialDocument = gql`
    query GetCredential($tenant_id: uuid!, $id: uuid!) {
  credential(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}) {
    id
    tenant_id
    name
    key
    ...
    `;
export const GetCredentialIdByNameDocument = gql`
...
export const UpdateCredentialDocument = gql`
    mutation UpdateCredential($tenant_id: uuid!, $id: uuid!, $name: String!, $value: json!, $updated_at: timestamptz!) {
  update_credential(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}, _set: {name: $name, value: $value, updated_at: $updated_at}) {
    returning {
      id
    }
  }
...
export const DeleteExporterDocument = gql`
    mutation DeleteExporter($tenant_id: uuid!, $id: uuid!) {
  delete_exporter(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}) {
    returning {
      id
    }
  }
...
export const GetExporterDocument = gql`
    query GetExporter($tenant_id: uuid!, $id: uuid!) {
  exporter(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}) {
    id
    tenant_id
    name
    key
    ...
    `;
export const GetExporterIdByNameDocument = gql`
...
export const UpdateExporterDocument = gql`
    mutation UpdateExporter($tenant_id: uuid!, $id: uuid!, $name: String!, $config: json!, $credential_id: uuid, $updated_at: timestamptz!) {
  update_exporter(where: {tenant_id: {_eq: $tenant_id}, id: {_eq: $id}}, _set: {name: $name, config: $config, credential_id: $credential_id, updated_at: $updated_at}) {
    returning {
      id
    }
  }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CreateCredentials(variables: CreateCredentialsMutationVariables): Promise<{ data?: CreateCredentialsMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<CreateCredentialsMutation>(print(CreateCredentialsDocument), variables));
    },
    DeleteCredential(variables: DeleteCredentialMutationVariables): Promise<{ data?: DeleteCredentialMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<DeleteCredentialMutation>(print(DeleteCredentialDocument), variables));
    },
    GetCredential(variables: GetCredentialQueryVariables): Promise<{ data?: GetCredentialQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetCredentialQuery>(print(GetCredentialDocument), variables));
    },
    GetCredentialIdByName(variables: GetCredentialIdByNameQueryVariables): Promise<{ data?: GetCredentialIdByNameQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetCredentialIdByNameQuery>(print(GetCredentialIdByNameDocument), variables));
    },
    GetCredentials(variables: GetCredentialsQueryVariables): Promise<{ data?: GetCredentialsQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetCredentialsQuery>(print(GetCredentialsDocument), variables));
    },
    GetCredentialsDump(variables?: GetCredentialsDumpQueryVariables): Promise<{ data?: GetCredentialsDumpQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetCredentialsDumpQuery>(print(GetCredentialsDumpDocument), variables));
    },
    SubscribeToCredentialList(variables?: SubscribeToCredentialListSubscriptionVariables): Promise<{ data?: SubscribeToCredentialListSubscription | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SubscribeToCredentialListSubscription>(print(SubscribeToCredentialListDocument), variables));
    },
    UpdateCredential(variables: UpdateCredentialMutationVariables): Promise<{ data?: UpdateCredentialMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<UpdateCredentialMutation>(print(UpdateCredentialDocument), variables));
    },
    CreateExporters(variables: CreateExportersMutationVariables): Promise<{ data?: CreateExportersMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<CreateExportersMutation>(print(CreateExportersDocument), variables));
    },
    DeleteExporter(variables: DeleteExporterMutationVariables): Promise<{ data?: DeleteExporterMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<DeleteExporterMutation>(print(DeleteExporterDocument), variables));
    },
    GetExporter(variables: GetExporterQueryVariables): Promise<{ data?: GetExporterQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetExporterQuery>(print(GetExporterDocument), variables));
    },
    GetExporterIdByName(variables: GetExporterIdByNameQueryVariables): Promise<{ data?: GetExporterIdByNameQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetExporterIdByNameQuery>(print(GetExporterIdByNameDocument), variables));
    },
    GetExporters(variables: GetExportersQueryVariables): Promise<{ data?: GetExportersQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetExportersQuery>(print(GetExportersDocument), variables));
    },
    GetExportersDump(variables?: GetExportersDumpQueryVariables): Promise<{ data?: GetExportersDumpQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetExportersDumpQuery>(print(GetExportersDumpDocument), variables));
    },
    SubscribeToExporterList(variables?: SubscribeToExporterListSubscriptionVariables): Promise<{ data?: SubscribeToExporterListSubscription | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SubscribeToExporterListSubscription>(print(SubscribeToExporterListDocument), variables));
    },
    UpdateExporter(variables: UpdateExporterMutationVariables): Promise<{ data?: UpdateExporterMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<UpdateExporterMutation>(print(UpdateExporterDocument), variables));
    },
    ...
    GetAlertmanager(variables: GetAlertmanagerQueryVariables): Promise<{ data?: GetAlertmanagerQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetAlertmanagerQuery>(print(GetAlertmanagerDocument), variables));
    },
    GetTenantById(variables: GetTenantByIdQueryVariables): Promise<{ data?: GetTenantByIdQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetTenantByIdQuery>(print(GetTenantByIdDocument), variables));
    },
    GetTenantByName(variables: GetTenantByNameQueryVariables): Promise<{ data?: GetTenantByNameQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetTenantByNameQuery>(print(GetTenantByNameDocument), variables));
    },
    ...
    UpdateAlertmanager(variables: UpdateAlertmanagerMutationVariables): Promise<{ data?: UpdateAlertmanagerMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<UpdateAlertmanagerMutation>(print(UpdateAlertmanagerDocument), variables));
    },
    ...
    DeactivateUser(variables: DeactivateUserMutationVariables): Promise<{ data?: DeactivateUserMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<DeactivateUserMutation>(print(DeactivateUserDocument), variables));
    },
    GetActiveUserForAuth(variables: GetActiveUserForAuthQueryVariables): Promise<{ data?: GetActiveUserForAuthQuery | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetActiveUserForAuthQuery>(print(GetActiveUserForAuthDocument), variables));
    },
    ...
    UpdateUserSession(variables: UpdateUserSessionMutationVariables): Promise<{ data?: UpdateUserSessionMutation | undefined; extensions?: any; headers: Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<UpdateUserSessionMutation>(print(UpdateUserSessionDocument), variables));
    }
  };
}
