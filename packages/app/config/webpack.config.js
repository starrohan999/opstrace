...
module.exports = function (webpackEnv) {
  ...
  // Allow to build workbox with dev mode so we get the debugging
  const isWorkboxDebug =
    process.argv.includes("--workbox-debug") || !isEnvProduction;
    ...
    plugins: [
      ...
      isEnvProduction &&
        new WorkboxWebpackPlugin.InjectManifest({
          ...
          mode: isWorkboxDebug ? "development" : "production",
          swDest: "service-worker.js",
          swSrc: paths.swTemplate,
          include: [/\.js$/, /\.css$/]
        }),
